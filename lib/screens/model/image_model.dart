...
class ImageModel {
  ...
  User user;
  ImageModelCoverPhoto coverPhoto;
  ...
  factory ImageModel.fromJson(Map<String, dynamic> json) => ImageModel(
    ...
    coverPhoto: ImageModelCoverPhoto.fromJson(json["cover_photo"]),
...
class ImageModelCoverPhoto {
  ...
  factory ImageModelCoverPhoto.fromJson(Map<String, dynamic> json) => ImageModelCoverPhoto(
    id: json["id"],
    slug: json["slug"],
